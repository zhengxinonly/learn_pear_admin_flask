  ...
  function (exports) {
    ...
    var pearAdmin = new (function () {
      ...
      this.refresh = function () {
        ...
        refreshBtn.addClass(
          "layui-anim layui-anim-rotate layui-anim-loop layui-icon-loading",
        );
        ...
        if (
          ...
          pearAdmin.instances.tabPage.refresh(true);
        else pearAdmin.instances.page.refresh(true);
        setTimeout(function () {
          refreshBtn.removeClass(
            "layui-anim layui-anim-rotate layui-anim-loop layui-icon-loading",
          );
    ...
    $(window).on(
      ...
      tools.debounce(function () {
        if (
          pearAdmin.instances.menu &&
          !pearAdmin.instances.menu.isCollapse &&
          $(window).width() <= 768
        ) {
          collapse();
        }
